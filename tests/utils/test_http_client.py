...
from speechify.core.http_client import (
    AsyncHttpClient,
    HttpClient,
    _build_url,
    _should_retry,
...
@patch("speechify.core.http_client.time.sleep", return_value=None)
...
@pytest.mark.asyncio
@patch("speechify.core.http_client.asyncio.sleep", new_callable=AsyncMock)
